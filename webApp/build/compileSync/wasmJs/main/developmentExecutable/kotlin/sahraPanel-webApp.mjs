...
import { importObject, setWasmExports } from './sahraPanel-webApp.import-object.mjs'
...
const wasmFilePath = './sahraPanel-webApp.wasm';
...
try {
  ...
  if (isBrowser) {
    wasmInstance = (await WebAssembly.instantiateStreaming(fetch(new URL('./sahraPanel-webApp.wasm',import.meta.url).href), importObject, wasmOptions)).instance;
  }
} catch (e) {

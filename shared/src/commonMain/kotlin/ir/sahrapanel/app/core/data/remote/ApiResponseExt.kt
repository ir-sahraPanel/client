...
suspend inline fun <reified T> safeApiCall(
    ...
    Result.failure(AppNetworkException.LocalNetworkException(NetworkErrorType.TIMEOUT))
} catch (e: IOException) {
    Result.failure(AppNetworkException.LocalNetworkException(NetworkErrorType.NO_INTERNET))
    ...
    try {
        ...
        Result.failure(AppNetworkException.LocalNetworkException(NetworkErrorType.UNKNOWN))
    }
} catch (e: Exception) {
    Result.failure(AppNetworkException.LocalNetworkException(NetworkErrorType.UNKNOWN))
}
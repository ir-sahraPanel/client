...
@Entity(
    ...
    foreignKeys = [
        ForeignKey(entity = _root_ide_package_.ir.sahrapanel.app.core.data.dataSource.local.db.entity.ClientEntity::class, parentColumns = ["id"], childColumns = ["client_id"], onDelete = ForeignKey.RESTRICT),
        ForeignKey(entity = _root_ide_package_.ir.sahrapanel.app.core.data.dataSource.local.db.entity.SalonEntity::class, parentColumns = ["id"], childColumns = ["salon_id"], onDelete = ForeignKey.RESTRICT),
        ForeignKey(entity = _root_ide_package_.ir.sahrapanel.app.core.data.dataSource.local.db.entity.ExtraServiceEntity::class, parentColumns = ["id"], childColumns = ["extra_services_id"], onDelete = ForeignKey.RESTRICT)
    ],

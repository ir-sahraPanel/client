...
@Entity(
    ...
    foreignKeys = [
        ForeignKey(entity = _root_ide_package_.ir.sahrapanel.app.core.data.data_source.local.db.entity.EmployeeEntity::class, parentColumns = ["id"], childColumns = ["employee_id"], onDelete = ForeignKey.CASCADE),
        ForeignKey(entity = _root_ide_package_.ir.sahrapanel.app.core.data.data_source.local.db.entity.SalonEntity::class, parentColumns = ["id"], childColumns = ["salon_id"], onDelete = ForeignKey.CASCADE)
    ],

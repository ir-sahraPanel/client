...
@Entity(
    ...
    foreignKeys = [
        ForeignKey(entity = _root_ide_package_.ir.sahrapanel.app.core.data.dataSource.local.db.entity.ClientInvoiceEntity::class, parentColumns = ["id"], childColumns = ["client_invoice_id"], onDelete = ForeignKey.RESTRICT)
    ],

...
@Entity(
    ...
    foreignKeys = [
        ForeignKey(entity = _root_ide_package_.ir.sahrapanel.app.core.data.data_source.local.db.entity.ClientInvoiceEntity::class, parentColumns = ["id"], childColumns = ["client_invoice_id"], onDelete = ForeignKey.CASCADE), // طبق V23 به CASCADE تغییر یافت
        ForeignKey(entity = _root_ide_package_.ir.sahrapanel.app.core.data.data_source.local.db.entity.EmployeeServiceEntity::class, parentColumns = ["id"], childColumns = ["employee_services_id"], onDelete = ForeignKey.RESTRICT)
    ],

...
import ir.sahrapanel.app.core.data.model.CityDto
import ir.sahrapanel.app.core.data.model.ProvinceDto
...
class LocationDataSource(private val client: HttpClient) {
    ...
    suspend fun getCities(provinceId: Long): Result<List<CityDto>> =
        safeApiCall {
